...
--
-- Name: tb_order fkpwlywcchg27nubkwtfjp2p7yt; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order
    ADD CONSTRAINT fkpwlywcchg27nubkwtfjp2p7yt FOREIGN KEY (cliente_id) REFERENCES public.tb_user(id);
